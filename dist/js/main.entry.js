...
/***/ function(module, exports, __webpack_require__) {
	...
	var _comment = __webpack_require__(1);
	...
	var _CommentBoxComponent = __webpack_require__(161);

	var _CommentBoxComponent2 = _interopRequireDefault(_CommentBoxComponent);

	var _HelloComponent = __webpack_require__(166);
	...
	var commentData = [{ author: "张三1", time: "20150721", text: "张三说好" }, { author: "李四1", time: "20150721", text: "李四说好" }];

	_reactDom2.default.render(_react2.default.createElement(_CommentBoxComponent2.default, { commentItems: commentData }), document.body);
	//
	//ReactDOM.render(
	//    <HelloComponent />,
	//    document.body
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CommentListComponent = __webpack_require__(162);

	var _CommentListComponent2 = _interopRequireDefault(_CommentListComponent);

	var _CommentFormComponent = __webpack_require__(165);

	var _CommentFormComponent2 = _interopRequireDefault(_CommentFormComponent);
	...
	var CommentBoxComponent = function (_React$Component) {
		_inherits(CommentBoxComponent, _React$Component);

		//getInitialState(){
		//	return this.props.commentItems;
		//}

		function CommentBoxComponent(props) {
			_classCallCheck(this, CommentBoxComponent);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(CommentBoxComponent).call(this, props));

			_this.state = { commentItems: props.commentItems };
			_this.addCommentItem = _this.addCommentItem.bind(_this);
			return _this;
		}

		_createClass(CommentBoxComponent, [{
			key: 'addCommentItem',
			value: function addCommentItem(newData) {
				// 重新向里面添加新的数据
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(_CommentListComponent2.default, { commentItems: this.state.commentItems }),
					_react2.default.createElement(_CommentFormComponent2.default, { addData: this.addCommentItem })
				);
			}
		}]);
	...
	exports.default = CommentBoxComponent;
	;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CommentComponent = __webpack_require__(163);
	...
	var CommentListComponent = function (_React$Component) {
		...
		function CommentListComponent() {
			...
			return _possibleConstructorReturn(this, Object.getPrototypeOf(CommentListComponent).apply(this, arguments));
		}
		...
		_createClass(CommentListComponent, [{
			...
			value: function render() {
				var commentItems = this.props.commentItems.map(function (item) {
					return _react2.default.createElement(_CommentComponent2.default, {
						author: item.author,
						time: item.time,
						text: item.text });
				});
				return _react2.default.createElement(
					'div',
					{ id: 'commentList', className: 'commentList' },
					commentItems
				);
			}
		}]);
		...
		_createClass(CommentComponent, [{
			...
			value: function render() {
				return _react2.default.createElement(
					"div",
					{ className: "comment" },
					_react2.default.createElement("img", { className: "comment_img", src: __webpack_require__(164) }),
					_react2.default.createElement(
						"div",
						{ className: "comment_con" },
						_react2.default.createElement(
							"span",
					...
					_react2.default.createElement(
						"div",
						{ className: "comment_act" },
						_react2.default.createElement(
							"a",
							{ className: "reply", href: "javascript:void(0)", onClick: this.handleReply },
							"回复"
						),
						_react2.default.createElement(
							"a",
							{ className: "cancel", href: "javascript:void(0)", style: { display: this.state.display } },
							"取消回复"
						)
					)
				);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "img/a49cbb96.foot.png";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CommentFormComponent = function (_React$Component) {
		...
		function CommentFormComponent(props) {
			...
			_this.authorChange = _this.authorChange.bind(_this);
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						null,
						"用户名：",
						_react2.default.createElement("input", { id: "author", ref: "author", value: this.state.author, onChange: this.authorChange }),
						_react2.default.createElement(
							"label",
							{ "for": "author" },
							"author"
					...
					_react2.default.createElement(
						...
						null,
						"内容：",
						_react2.default.createElement("input", { id: "text", ref: "text", value: this.state.text, onChange: this.textChange }),
						_react2.default.createElement(
							"label",
							{ "for": "text" },
							"text"
					...
					_react2.default.createElement("input", { type: "button", value: "发表", onClick: this.handleClick })
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HelloComponent = function (_React$Component) {
		...
		function HelloComponent() {
			...
			return _possibleConstructorReturn(this, Object.getPrototypeOf(HelloComponent).apply(this, arguments));
		}
